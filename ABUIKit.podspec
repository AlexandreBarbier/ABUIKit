...
Pod::Spec.new do |s|
  ...
  multiple micro lib to bootstrap ios apps"
                   DESC
  s.homepage     = "https://github.com/AlexandreBarbier/ABUIKit"
  ...
  s.source       = { :git => "https://github.com/AlexandreBarbier/ABUIKit.git", :tag => "#{s.version}" }
  s.source_files  = "ABUIKit/*.swift"
